...
int main()
{
    ...
    {
        for (Loop_Iterator_Two=1;Loop_Iterator_Two<=rows/2-Loop_Iterator_One;Loop_Iterator_Two++)
        {
            printf(" ");
        }
        for (Loop_Iterator_Two=1;Loop_Iterator_Two<=Loop_Iterator_One;Loop_Iterator_Two++)
        {
            if ((1==Loop_Iterator_Two)||(Loop_Iterator_Two==Loop_Iterator_One))
                {
                    printf("* ");
                }
            else
...
user                    date            brief
************************************************************
Ahmed Mohamed Omar   12/5/2022 tasks of Loop and coditions
